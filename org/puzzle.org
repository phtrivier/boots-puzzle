...
** TODO unmovable
*** TODO Define a 'unmovable' type of cells that, where you move on it, moves you back to your original place,
and calls up a block with the direction in with it is touched
** TODO swicth
*** TODO Define a 'swicth' type of cells
(unmovable),
keeps a 'toggled' state (where you can
define a 'on' and a 'off' event like this

story_switch :switch do

  on do |puzzle|
    puzzle.message("you switched me on!!")
  end

  off do
    puzzle.message("you switched me off!")
  end
