* Game Engine
** TODO Find a way to 'guess' how levels should be named from their files (see in rails how they do ...)
** TODO Find a way to 'guess' the name of the story (depending on the name of the class, the file, etc...)
** TODO Find a way to have to write less stuff to define a story module (only the name of the puzzle, and the content of the init method...)
...
** TODO Improve story system to add a flag telling if the event has already occured
** TODO Make it easier to declare CellTools (when there is only a cell type to pass ... don't have them write anything else!)
