...
* Puzzle Editor
** TODO [BUG] On ne peut pas charger log4r dans shoes, apparement ? En tout ca ca merde grave.
(no such file - log4r)
** TODO [#A] Adventure editor
*** DONE Load an adventure file
**** Adventure editing
...
*** DONE [#A] Load all plugins from the adventure (so that tools, cells, etc... can be loaded)
*** TODO Create a new level if necessary (just ask the name of it, and its dimensions (with nice defaults!!)
** TODO [#B] Undo ?
